...
def train(epoch):
    ...
    total_width_sum = sum(width_list)
    width_weights = [width / total_width_sum for width in width_list]
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        for n, m in net.named_modules():
            width_id = random.choices(range(len(width_list)), weights=width_weights)[0]
